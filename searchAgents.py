...
class CornersProblem(search.SearchProblem):
  ...
  def __init__(self, startingGameState):
    ...
    State format: [position, visited corners)
    position: (x, y)
    visited corners: [False,False,False,False]
    """
...
#The algorithm calculates the cummuliative distance of the goals the pacman hasn't visited starting from the nearest goal
